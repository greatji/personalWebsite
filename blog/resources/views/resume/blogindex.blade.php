...
which means that you are free to use it for any personal or commercial purpose provided you credit me in the form of a link back to <a href="http://www.cssmoban.com/" title="ģ°å¼Ò>ģ°å¼Ò/a>.</p>
          ...
          <p>
		<a href="/index.php/blog/showAll/{{$point->title}}" target="_blank">Read more </a>
		<a href="/index.php/blog/delete/{{$point->title}}" data-toggle="modal" style="margin-left:20px" onclick="toDelete=48">Delete this shit </a>
		<a href="/index.php/blog/rewrite/{{$point->title}}" style="margin-left:20px" target="_blank">Edit </a>
	</p>
        </div>
        <?php } ?>
      ...
      <?php if($current > 1) echo '<a href="/index.php/blog/newlist/'.$type.'/'.($current-1).'">newer posts</a>'?>
      <?php if($current+1 <= (int)($total/4+1)) echo '<a href="/index.php/blog/newlist/'.$type.'/'.($current+1).'">older posts</a>'?>
      ...
      <div class="sidebar">
        <div class="gadget">
          <h2>Actions</h2>
          <div class="clr"></div>
    	<li><a href="/index.php/blog/writeblog" target="_blank">Publish an article!</a></li>
        <li><a href="/index.php/auth/logout">登出</a></li>
        ...
        <div class="gadget">
          <h2><span>标签</span></h2>
          <div class="clr"></div>
          <li><a href="/index.php/blog/newlist">show all</a><br>
          <?php foreach ($label as $l) {?>
			   <li><a href="/index.php/blog/newlist/{{$l->label}}">{{$l->label}}</a><a href="/index.php/blog/deletelabel/{{$l->label}}" data-toggle="modal" style="margin-left:20px" title="{{$l->label}}" onclick="labelname=&#39;{{$l->label}}&#39;">delete</a><br>
          <?php } ?>
